 ...
 */
declare const Lightbox: ({ isOpen, onClose, inline, images, currentIndex, onPrev, onNext, renderHeader, renderFooter, renderPrevButton, renderNextButton, renderImageOverlay, className, singleClickToZoom, style, pageTransitionConfig, }: ILightboxProps) => JSX.Element;
